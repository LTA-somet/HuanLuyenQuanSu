...
namespace WorldSpaceTransitions
{
    public class CrossSectionDepthNormalsFeature : ScriptableRendererFeature
    {
        ...
        {
            if (settings.depthNormalsShader == null)
            {
                Debug.LogWarningFormat("Missing Depth Normal Shader");
                depthNormalsMaterial = CoreUtils.CreateEngineMaterial("Hidden/Internal-DepthNormalsTexture");
            }
            else
            {
                depthNormalsMaterial = CoreUtils.CreateEngineMaterial(settings.depthNormalsShader);
            }
            depthNormalsPass = new DepthNormalsPass(RenderQueueRange.opaque, settings.layerMask, depthNormalsMaterial);
            depthNormalsPass.renderPassEvent = settings.renderPassEvent;
